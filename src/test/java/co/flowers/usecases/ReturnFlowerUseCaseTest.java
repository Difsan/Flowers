...
class ReturnFlowerUseCaseTest {
    ...
    ReturnFlowerUseCase returnFlowerUseCase;

    @BeforeEach
    void setUp() {
        mapper = new ModelMapper();
        returnFlowerUseCase = new ReturnFlowerUseCase(repository, mapper, flowerPublisher);
    }
    ...
    void buyFlower() {
        ...
        try{
            Mockito.verify(flowerPublisher, times(1)).publishReturn(any(FlowerDTO.class), any(String.class));
    ...
    void buyFlower_Failed(){
        ...
        try{
            Mockito.verify(flowerPublisher, never()).publishReturn(any(FlowerDTO.class), any(String.class));
        } catch (JsonProcessingException e){
            System.out.println(e.getMessage());
        }
    }
